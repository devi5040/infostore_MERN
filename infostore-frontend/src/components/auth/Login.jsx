...
function Login( { closeModal } ) {
    ...
    return (
        <Fragment>
            ...
            { isSignup && <Signup closeModal={ closeSignupModal } /> }
            <Modal modalHeading='Login' closeModal={ closeModal }>
                <form action="">
                    ...
                    <h3 className='my-2 text-md font-semibold'>Don't have an account? Go to <span className="cursor-pointer" onClick={ openSignupModal }>Signup</span></h3>
