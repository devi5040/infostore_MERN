        ...
        <>
            <Modal editingHandler={ editingHandler } closeModal={ closeModal } modalHeading='Add Document'>
                ...
                <div className='flex justify-between'>
                    <button onClick={ closeModal } className='bg-secondary text-primary w-[100px] py-1 rounded-md my-2 cursor-pointer border border-secondary hover:bg-primary hover:text-secondary duration-300'>Submit</button>
